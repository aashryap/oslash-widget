...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".button {\n    min-width: 70px; \n    border-radius: 2px;\n    background-color: yellow;\n}\n\n.primary {\n    background-color: #24a0ed;\n    color: black;\n}\n\n.button-with-icon {\n    color: black;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.button-icon {\n    \n}", "",{"version":3,"sources":["webpack://./src/common/Button/button.css"],"names":[],"mappings":"AAAA;IACI,eAAe;IACf,kBAAkB;IAClB,wBAAwB;AAC5B;;AAEA;IACI,yBAAyB;IACzB,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;;AAEA","sourcesContent":[".button {\n    min-width: 70px; \n    border-radius: 2px;\n    background-color: yellow;\n}\n\n.primary {\n    background-color: #24a0ed;\n    color: black;\n}\n\n.button-with-icon {\n    color: black;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.button-icon {\n    \n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.43e936f1f5341b1dd439.hot-update.js.map