...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".button {\n    min-width: 70px; \n    min-height: 30px; \n    border-radius: 4px;\n    border: none\n}\n\n.primary {\n    background-color: #24a0ed;\n    color: black;\n}\n\n.button-with-icon {\n    color: black;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n", "",{"version":3,"sources":["webpack://./src/common/Button/button.css"],"names":[],"mappings":"AAAA;IACI,eAAe;IACf,gBAAgB;IAChB,kBAAkB;IAClB;AACJ;;AAEA;IACI,yBAAyB;IACzB,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;AACvB","sourcesContent":[".button {\n    min-width: 70px; \n    min-height: 30px; \n    border-radius: 4px;\n    border: none\n}\n\n.primary {\n    background-color: #24a0ed;\n    color: black;\n}\n\n.button-with-icon {\n    color: black;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.712bf91aa7e851681b6e.hot-update.js.map